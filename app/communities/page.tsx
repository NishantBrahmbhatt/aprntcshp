...
const communities = [
  {
    name: "Apprentease",
    description: "Peer-led community helping students secure apprenticeships through resources, mentorship, and support.",
    url: "https://discord.com/invite/UXKYgRB6ux",
    logo: "/logos/apprentease.jpg",
  },
  {
    name: "Apprentilink",
    description: "Connecting students to apprenticeship opportunities and communities across the UK.",
    url: "https://www.allapprenticenetwork.co.uk/?utm_source=chatgpt.com",
    logo: "/logos/apprentilink.jpg",
  },
  {
    name: "Arab Asian Network",
    description: "Network connecting Asian and Arab apprentices and students exploring apprenticeship routes.",
    url: "https://www.linkedin.com/company/asianarabnetwork/",
    logo: "/logos/aan.jpg",
  },
  {
    name: "Black Apprenticeship Network",
    description: "Supporting and empowering Black apprentices through networking, career support, and professional development.",
    url: "https://www.blackapprenticenetwork.co.uk/",
    logo: "/logos/ban2.png",
  },
  {
    name: "Hindu Apprentice Network",
    description: "Supporting Hindu apprentices and students considering apprenticeship pathways in the UK.",
    url: "https://www.linkedin.com/in/hindu-apprentice-network-uk-7874a338b/",
    logo: "/logos/hinduapprenticeshipsnetworklogo.jpg",
  },
  {
    name: "Investate",
    description: "Student-led initiative introducing young people to investing, finance, and related pathways.",
    url: "https://www.linkedin.com/company/investate-uk/posts/?feedView=all",
    logo: "/logos/investate.jpg",
  },
  {
    name: "Mentup",
    description: "Mentorship-focused support for UK students looking to break into apprenticeships.",
    url: "https://www.linkedin.com/company/mentup-uk/",
    logo: "/logos/mentuplogo.jpg",
  },
  {
    name: "Muslim Apprentice Community",
    description: "Community space for Muslim apprentices and aspiring apprentices across the UK.",
  ...
  },
  {
    ...
    description: "Network focused on supporting women in apprenticeships through community and resources.",
  ...
  },
  {
    ...
    description: "Resource helping students research apprenticeship schemes and opportunities in detail.",
  ...
  {
    name: "MyLaunchpad",
    description: "Platform helping young people launch their careers through apprenticeships.",
    url: "https://www.linkedin.com/company/mylaunchpaduk/",
    logo: "/logos/mylaunchpaduk_logo.jpg",
  },
  {
    name: "Apprentice Alliance",
    description: "Alliance connecting apprentices and employers across the UK.",
...
function OrganisationLogo({ src, alt }: { src: string; alt: string }) {
  ...
  if (!src || src.trim() === "" || errored) {
    return <div className="mt-0.5 h-14 w-14 bg-neutral-800 flex-shrink-0" />;
  }

  return (
    <div className="mt-0.5 h-14 w-14 bg-neutral-900 flex items-center justify-center overflow-hidden flex-shrink-0">
      <Image
        src={src}
        alt={alt}
        width={56}
