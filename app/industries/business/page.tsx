...
import { general } from "@/lib/data/industries/business";

const SECTION_IDS = {
  general: "business-section-general",
} as const;
...
function PageHeader() {
  return (
    <section className="pt-8 pb-10">
      <IndustryBreadcrumb industryLabel="Business & Administration" />
      <div className="space-y-3">
        ...
        <p className="text-sm sm:text-base text-neutral-500 max-w-2xl">
          Everything you need to pursue a business or administration
          apprenticeship.
        </p>
      </div>
    </section>
...
export default function BusinessIndustryPage() {
  ...
  useLayoutEffect(() => {
    const sections = [generalRef.current].filter(
